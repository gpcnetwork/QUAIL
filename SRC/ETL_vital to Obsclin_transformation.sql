...
CREATE OR  REPLACE TABLE allina_vital_insert_wt AS
...
/*vital HT inserted to obsclin */
CREATE OR REPLACE TABLE allina_vital_insert_HT AS 
...
CREATE OR REPLACE TABLE allina_vital_insert_BMI AS 
...
CREATE OR REPLACE TABLE allina_vital_insert_DBP AS 
...
CREATE OR REPLACE TABLE allina_vital_insert_SBP AS
...
WHERE systolic IS NOT NULL ;
 ...
 /*vital tobacco_type  nserted to obsclin */
CREATE OR REPLACE TABLE vital_insert_tobacco_type AS 
...
WHERE tobacco_type IS NOT NULL;
  ...
  /*vital tobacco  nserted to obsclin */
CREATE OR REPLACE TABLE vital_insert_tobacco AS
...
/*vital smoking nserted to obsclin */
CREATE OR REPLACE TABLE vital_insert_smoking AS 
...
/*Create whole table for vital signs */
CREATE OR REPLACE TABLE Allina_INSERT_IN_OBC_vital AS 
SELECT * FROM  GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.allina_vital_insert_wt
UNION 
SELECT * FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.allina_vital_insert_ht
UNION 
SELECT * FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.allina_vital_insert_bmi
UNION 
SELECT * FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.allina_vital_insert_dbp
UNION 
SELECT * FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.ALLINA_VITAL_INSERT_SBP

;

/*Create whole table for tobacco data */
CREATE OR REPLACE TABLE Allina_INSERT_IN_OBC_tobacco AS 
SELECT * FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.vital_insert_tobacco_type
UNION 
SELECT * FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.vital_insert_tobacco
UNION 
SELECT * FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.vital_insert_smoking
;
...
FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.Allina_INSERT_IN_OBC_vital
;
...
FROM GROUSE_DB_QUAIL.DQ_CLEAN_TABLE.ALLINA_INSERT_IN_OBC_TOBACCO
;
