...
WITH ALLINA_vital_insert_wt AS (SELECT 
	...
	'LC' AS RAW_OBSCLIN_TYPE,
	'Body weight' AS RAW_OBSCLIN_NAME,
	'kg' AS OBSCLIN_RESULT_UNIT, ---NO UNITS IN VITAL
	'LC' AS OBSCLIN_TYPE,
	NULL AS OBSCLIN_PROVIDERID,
	WT AS OBSCLIN_RESULT_NUM ,
	NULL AS OBSCLIN_STOP_DATE ,
...
ALLINA_vital_insert_HT AS (SELECT 
	...
	'LC' AS RAW_OBSCLIN_TYPE,
	'Body height' AS RAW_OBSCLIN_NAME,
	'cm' AS OBSCLIN_RESULT_UNIT, ---NO UNITS IN VITAL
	'LC' AS OBSCLIN_TYPE,
	NULL AS OBSCLIN_PROVIDERID,
	HT AS OBSCLIN_RESULT_NUM ,
	NULL AS OBSCLIN_STOP_DATE ,
...
ALLINA_vital_insert_BMI AS (SELECT 
	...
	'39156-5' AS RAW_OBSCLIN_CODE ,
	'LC' AS RAW_OBSCLIN_TYPE,
	'Boby mass index (BMI)[Ratio]' AS RAW_OBSCLIN_NAME,
	'kg/m2' AS OBSCLIN_RESULT_UNIT, 
	'LC' AS OBSCLIN_TYPE,
	NULL AS OBSCLIN_PROVIDERID,
	original_bmi AS OBSCLIN_RESULT_NUM ,
...
ALLINA_vital_insert_SBP AS (SELECT 
	...
	'LC' AS RAW_OBSCLIN_TYPE,
	'Systolic blood pressure' AS RAW_OBSCLIN_NAME,
	'mm[Hg]' AS OBSCLIN_RESULT_UNIT, ---NO UNITS IN VITAL
	'LC' AS OBSCLIN_TYPE,
	NULL AS OBSCLIN_PROVIDERID,
	systolic AS OBSCLIN_RESULT_NUM ,
	NULL AS OBSCLIN_STOP_DATE ,
...
IHC_vital_insert_BMI AS (SELECT 
    ...
    MEASURE_TIME  AS OBSCLIN_START_TIME,
    NULL AS	RESULT_UNIT ,
   'Body mass idnex (BMI)[Ratio]' AS RAW_OBSCLIN_NAME ,
   '39156-5' AS OBSCLIN_CODE ,
    NULL AS	OBSCLIN_SOURCE 
FROM GROUSE_DB.PCORNET_CDM_IHC.LDS_VITAL
WHERE ORIGINAL_BMI IS NOT NULL),
...
UNION
SELECT * FROM GROUSE_DB.PCORNET_CDM_UTHSCSA.LDS_OBS_CLIN;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////UTSW////////////////////////////////////////////////////////////////////////////
